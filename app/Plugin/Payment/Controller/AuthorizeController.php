...
class AuthorizeController extends PaymentAppController {
	...
	public function after_process()
	{
		...
		//cloudkassir отправка чека
		    if ($payment_method['PaymentMethod']['cloudkassir']==1) 
		    {
		        $this->send_receipt($_SESSION['Customer']['order_id'],Income); 
		        $order_data['Order']['cloudkassir'] = 1;
		    };
	    //cloudkassir отправка чека
